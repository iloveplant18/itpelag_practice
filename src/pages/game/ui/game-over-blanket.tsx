...
export default function GameOverBlanket() {
  ...
  return (
    <div className="glass bg-foreground/40 text-center text-background absolute inset-0 grid place-items-center uppercase font-bold  rounded-md starting:opacity-0 duration-(--animation-duration)">
      <div>
        <span className="text-4xl">game over<br /></span>
