...
export const gameSettingsActionsContext = createContext<GameSettingsActions | null>(null);

const initialBoardSize = 4;

export default function GameSettingsProvider({children}: HTMLAttributes<HTMLDivElement>) {
